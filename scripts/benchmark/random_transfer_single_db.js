...
/*
random_transfer_test.js

用途：
隨機產生 fromId / toId，持續對 /transfers 發送請求，
用來測試系統在分散帳戶情境下的吞吐量。
...
// 產生一筆合法的隨機轉帳資料
function buildRandomTransferPayload() {
...
async function main() {
  ...
  console.log('');
  console.log('========================================');
  console.log('Random Transfer Benchmark Finished');
  console.log('========================================');
