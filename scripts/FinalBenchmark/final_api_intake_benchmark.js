...
async function main() {
  const url = getArg('url', 'http://127.0.0.1:7001/bench/transfers-enqueue-no-log');
  ...
  console.log('========================================');
  console.log('Final API Intake / Enqueue Benchmark');
  console.log('========================================');
  console.log(`url           : ${url}`);
...
main().catch(err => {
  console.error('[final_api_intake_benchmark] failed:', err.message);
  process.exit(1);
});
